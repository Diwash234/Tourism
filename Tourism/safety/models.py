"""
safety/models.py -- moved from tourist/models.py.

db_table on each model keeps them reading/writing the SAME physical
tables they already used as `tourist.TrustedContact` etc. (if any real
data exists), instead of Django creating new empty tables under the
`safety` app and orphaning it.
"""
import uuid
...
class TrustedContact(models.Model):
    ...
    class Meta:
        ordering = ["-created_at"]
        db_table = "tourist_trustedcontact"
