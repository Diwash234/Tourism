...
urlpatterns = [
    ...
    path("auth/account/", views_auth.AccountDeleteView.as_view(), name="auth-account-delete"),
    ...
    path("admin/destinations/merge/", views_admin.AdminDestinationMergeView.as_view(), name="admin-destination-merge"),
    path("admin/import-conflicts/", views_admin.AdminImportConflictListView.as_view(), name="admin-import-conflicts"),
    path("admin/import-conflicts/<int:pk>/resolve/", views_admin.AdminImportConflictResolveView.as_view(), name="admin-import-conflict-resolve"),
    ...
    path("admin/destinations/bulk/", views_admin.AdminDestinationBulkView.as_view(), name="admin-destinations-bulk"),
    path("admin/data-health/", views_admin.AdminDataHealthView.as_view(), name="admin-data-health"),
    ...
    path("admin/travel-services/create/", views_admin.AdminTravelServiceCreateView.as_view(), name="admin-travel-service-create"),
    ...
    path("workforce/jobs/", views_workforce.TourismJobListView.as_view(), name="workforce-jobs"),
    path("workforce/job-applications/", views_workforce.TourismJobApplicationView.as_view(), name="workforce-job-applications"),
    path("workforce/admin/jobs/", views_workforce.TourismJobAdminView.as_view(), name="workforce-admin-jobs"),
    path("workforce/admin/jobs/<int:pk>/action/", views_workforce.TourismJobStatusView.as_view(), name="workforce-admin-job-action"),
    path("workforce/admin/job-applications/", views_workforce.AdminJobApplicationListView.as_view(), name="workforce-admin-job-applications"),
    path("workforce/admin/job-applications/<int:pk>/action/", views_workforce.AdminJobApplicationActionView.as_view(), name="workforce-admin-job-application-action"),
    path("workforce/guide-bookings/", views_workforce.GuideBookingRequestView.as_view(), name="workforce-guide-bookings"),
    path("workforce/guide-bookings/<int:pk>/action/", views_workforce.GuideBookingActionView.as_view(), name="workforce-guide-booking-action"),
    path("workforce/guide-bookings/<int:pk>/review/", views_workforce.GuideReviewCreateView.as_view(), name="workforce-guide-booking-review"),
    path("workforce/guides/<int:pk>/reviews/", views_workforce.GuideReviewListView.as_view(), name="workforce-guide-reviews"),
    path("workforce/admin/overview/", views_workforce.WorkforceOverviewView.as_view(), name="workforce-admin-overview"),
    path("workforce/guide-stats/", views_workforce.GuideStatsView.as_view(), name="workforce-guide-stats"),
    ...
    path("feedback/", views_admin.PublicFeedbackCreateView.as_view(), name="public-feedback-slash"),
