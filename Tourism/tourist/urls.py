...
urlpatterns = [
    ...
    path("admin/destinations/revisions/", views_admin.AdminDestinationRevisionsView.as_view(), name="admin-destination-revisions"),
    path("admin/destinations/<int:id>", views_admin.AdminDestinationDetailView.as_view(), name="admin-destination-detail"),
    path("admin/destinations/<int:id>/lifecycle/", views_admin.AdminDestinationLifecycleView.as_view(), name="admin-destination-lifecycle"),
    path("admin/destinations/<int:id>/preview/", views_admin.AdminDestinationPreviewView.as_view(), name="admin-destination-preview"),
    ...
    path("emergency/national-hotlines/", views.NationalEmergencyHotlinesView.as_view(), name="national-emergency-hotlines"),
