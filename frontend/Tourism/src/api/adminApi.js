...
const adminApi = {
  ...
  exploreSchema: (resource) => axiosClient.get("/admin/data-explorer/", { params: { resource, schema: 1 } }),
  exploreRow: (resource, id) => axiosClient.get("/admin/data-explorer/", { params: { resource, edit_id: id } }),
  updateExploreRow: (payload) => axiosClient.patch("/admin/data-explorer/", payload),
  createExploreRow: (payload) => axiosClient.post("/admin/data-explorer/", payload),
  deleteExploreRow: (resource, id) => axiosClient.delete("/admin/data-explorer/", { params: { resource, id } }),
  ...
  updateRoutingProvider: (config) => axiosClient.patch("/admin/routing-provider/", config),
