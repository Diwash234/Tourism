...
const adminApi = {
  ...
  validateDatasetUpload: (formData) => axiosClient.post("/admin/datasets/", formData, { headers: { "Content-Type": "multipart/form-data" }, timeout: 60000 }),
  ...
  uploadMediaLibrary: (payload) => axiosClient.post("/admin/media-library/", payload, { headers: { "Content-Type": "multipart/form-data" }, timeout: 60000 }),
  ...
  uploadHotelImage: (id, payload) => axiosClient.patch(`/hotels/${id}/`, payload, { headers: { "Content-Type": "multipart/form-data" }, timeout: 60000 }),
  ...
  uploadBrandingAsset: (formData) => axiosClient.post("/admin/branding/", formData, { headers: { "Content-Type": "multipart/form-data" }, timeout: 60000 }),
  ...
  getPOICategories: () => axiosClient.get("/admin/poi-categories/"),
  updatePOICategories: (payload) => axiosClient.put("/admin/poi-categories/", payload),
  getTripInterests: () => axiosClient.get("/admin/trip-interests/"),
  updateTripInterests: (payload) => axiosClient.put("/admin/trip-interests/", payload),
  ...
  updateContentBlock: (id, payload) => axiosClient.patch(`/admin/blocks/${id}/`, payload),
  deleteContentBlock: (id) => axiosClient.delete(`/admin/blocks/${id}/`),
  reorderContentBlocks: (payload) => axiosClient.post("/admin/blocks/reorder/", payload),
  ...
  uploadServiceMedia: (formData) => axiosClient.post("/admin/service-media/", formData, { headers: { "Content-Type": "multipart/form-data" }, timeout: 60000 }),
  ...
  getRateAdjustments: () => axiosClient.get("/admin/rate-adjustments/"),
  updateRateAdjustments: (payload) => axiosClient.post("/admin/rate-adjustments/", payload),
  ...
  sendFeedback: (payload) => axiosClient.post("/feedback", payload, payload instanceof FormData ? { headers: { "Content-Type": "multipart/form-data" }, timeout: 60000 } : undefined),
  ...
  addAdminDestinationImage: (id, payload) => axiosClient.post(`/admin/destinations/${id}/images`, payload, payload instanceof FormData ? { headers: { "Content-Type": "multipart/form-data" }, timeout: 60000 } : undefined),
  ...
  addAdminDestinationVideo: (id, payload) => axiosClient.post(`/admin/destinations/${id}/videos`, payload, payload instanceof FormData ? { headers: { "Content-Type": "multipart/form-data" }, timeout: 60000 } : undefined),
