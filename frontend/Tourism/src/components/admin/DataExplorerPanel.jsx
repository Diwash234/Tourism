...
export default function DataExplorerPanel() {
  ...
  const startCreate=()=>{setDetail({id:null,name:""});setEdit({name:"",short_description:"",description:"",city:"",district:"",province:"",municipality:"",latitude:"",longitude:"",altitude:"",best_time_to_visit:"",opening_hours:"",entry_fee:"",history:"",cultural_significance:"",food_cuisine_info:""})}
