    ...
    <section className="space-y-4 rounded-2xl border border-emerald-200 bg-white p-5 text-slate-900">
      <header className="flex flex-col gap-2 sm:flex-row sm:items-end">
        <div>
          ...
          <p className="text-sm text-slate-300">Add hospital, police, fire station and bank photos. Travellers see them on the Emergency page.</p>
        </div>
      ...
      {busy ? <p className="text-sm text-slate-300">Loading services…</p> : null}
