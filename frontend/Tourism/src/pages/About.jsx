...
const About = () => (
  <div className="container-app py-16 fade-in">
    <motion.h1 initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="section-title text-center mx-auto w-fit">
      About {APP_NAME}
    </motion.h1>
    <p className="max-w-2xl mx-auto text-center text-gray-500 mb-12">
      {APP_NAME} is a local tourism information portal built to help travelers discover Nepal's destinations,
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
      {[
        ...
        { icon: FiGlobe, title: "Our Reach", desc: "Covering destinations across Nepal with real-time alerts and translations." },
    ...
    <div className="card-base p-8 text-center bg-gradient-to-br from-himalaya-500 to-forest-600 text-white">
      <h2 className="text-xl font-heading font-bold mb-2">Ready to explore?</h2>
      <p className="text-white/80 mb-5 max-w-md mx-auto">
        See Nepal's history, culture, festivals, and heritage in one place.
      </p>
      <Link to="/discover-nepal" className="inline-flex items-center gap-2 bg-white text-himalaya-600 font-semibold px-5 py-2.5 rounded-xl hover:-translate-y-0.5 transition-transform">
        Discover Nepal <FiArrowRight size={16} />
      </Link>
    </div>
  </div>
)
