    ...
    <div className="container-app py-16 grid grid-cols-1 md:grid-cols-2 gap-10 fade-in theme-indigo">
      <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} className="space-y-6">
        ...
        <div className="space-y-4 text-sm text-gray-700 p-6 rounded-3xl bg-white border border-slate-200 shadow-sm">
          <p className="flex items-center gap-3 font-semibold">
            <FiMail className="text-purple-700 text-lg shrink-0" />
            <span>Official Email: <b>{contactEmail}</b></span>
          </p>

          <p className="flex items-center gap-3 font-semibold">
            <FiPhone className="text-purple-700 text-lg shrink-0" />
            <span>Support Phone: <b>{contactPhone}</b></span>
          </p>

          <p className="flex items-center gap-3 font-semibold">
            <FiMapPin className="text-purple-700 text-lg shrink-0" />
            <span>Address: <b>{contactAddress}</b></span>
          </p>

          <p className="flex items-center gap-3 text-xs text-gray-500 pt-2 border-t">
            <FiClock className="text-purple-700 shrink-0" />
      ...
      >
        <h3 className="font-extrabold text-lg text-slate-900 flex items-center gap-2">
          <FiShield className="text-purple-700" /> Send Message to Admin Desk
        </h3>
        ...
        <label className="block rounded-2xl border-2 border-dashed border-gray-200 p-4 text-center text-xs font-bold text-gray-500 cursor-pointer hover:border-purple-300">
