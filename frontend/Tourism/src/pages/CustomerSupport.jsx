                  ...
                  return (
                    <button
                      ...
                      className={`w-full text-left p-3.5 rounded-2xl border transition-all text-xs space-y-1 block ${
                        isSelected
                          ? "bg-purple-950/80 border-[#1D5146]/80 text-white shadow-lg"
            ...
            {showNewTicketForm ? (
              ...
              <div className="flex-1 flex flex-col min-h-0 space-y-3">
                ...
                <form onSubmit={handleSendReply} className="flex gap-2 pt-1">
                  ...
                  <button
                    ...
                    className="px-5 py-3 rounded-2xl bg-[#1D5146] hover:bg-[#102A2E] text-white font-black flex items-center gap-2 shadow disabled:opacity-50 text-xs"
                  >
                    <FiSend size={14} /> Send
                  </button>
                </form>
              ...
              <div className="flex-1 flex flex-col items-center justify-center p-8 text-center text-slate-500 space-y-3">
                ...
                <button
                  ...
                  className="py-2.5 px-5 rounded-xl bg-[#1D5146] hover:bg-[#102A2E] text-white font-bold text-xs shadow"
                >
