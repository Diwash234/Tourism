          ...
          <div className="bg-gradient-to-r from-purple-900 via-slate-900 to-slate-950 text-white p-6 rounded-3xl border border-purple-800/40 shadow-xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap items-center gap-2 shrink-0">
              ...
              <button
                ...
                className="px-4 py-2.5 rounded-2xl bg-[#1D5146] hover:bg-[#102A2E] text-white font-bold text-xs shadow transition-all flex items-center gap-1.5"
              >
          ...
          <div className="bg-white border border-slate-200 p-6 rounded-3xl shadow-sm space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  onClick={() => setShowFeedbackModal(true)}
                  className="px-4 py-2 rounded-xl bg-[#1D5146] hover:bg-[#102A2E] text-white text-xs font-bold shadow flex items-center gap-1.5"
                >
