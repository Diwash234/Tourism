...
import { FiSun, FiCloud, FiCloudRain, FiMapPin, FiHeart, FiHome } from "react-icons/fi"
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        ...
        subtitle="Here is what is happening with your trips today."
        icon={FiHome}
        theme="coral"
      />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <BudgetCard label="Total Budget" amount={budget?.total} accent="emerald" />
        <BudgetCard label="Spent So Far" amount={budget?.spent} accent="rose" />
      </div>
