...
const Hotels = () => {
  ...
  return (
    <div className="space-y-6 fade-in">
      <div>
        <h1 className="section-title mb-2">Hotels & Stays</h1>
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          subtitle="Try a different search, or check back once hotels are imported (see `python manage.py import_hotels`)."
        />
      )}
    </div>
  )
