...
export default function PartnerDesk() {
  ...
  return (
    <div className="container-app py-10 space-y-6" data-testid="partner-desk">
      <PageHeader
        title="Partner desk"
      ...
      {desk.can_manage_listings && (
        <div className="grid xl:grid-cols-[360px_1fr] gap-5">
          <form onSubmit={submit} className="card-base p-5 space-y-3" data-testid="partner-listing-form">
            ...
            <input className="input-field" required name="title" data-testid="partner-listing-title" placeholder="Title travellers will see" value={form.title} onChange={(e) => setForm({ ...form, title: e.target.value })} />
            ...
            <div className="grid grid-cols-2 gap-2">
              <input className="input-field" required name="price_npr" data-testid="partner-listing-price" placeholder="Price NPR" value={form.price_npr} onChange={(e) => setForm({ ...form, price_npr: e.target.value })} />
