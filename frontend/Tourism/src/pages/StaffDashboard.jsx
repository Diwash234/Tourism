...
export default function StaffDashboard({ module = "dashboard" }) {
  ...
  return <div className="space-y-6">
    ...
    {module === "dashboard" ? <>
      <p className="text-sm text-slate-600">Work only the tasks and queues assigned to your staff profile. Other admin tools stay hidden.</p>
