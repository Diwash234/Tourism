              ...
              <div className="p-4 bg-slate-50 border-y border-slate-100 space-y-2">
                ...
                <div className="flex flex-wrap gap-1.5 text-xs">
                  ...
                  <button
                    ...
                    className="px-2.5 py-1 rounded-xl bg-white border border-slate-200 hover:border-[#1D5146] text-slate-800 font-bold"
                  >
                    💎 Make it luxurious
                  </button>
                  <button
          ...
          <div className="card-base p-5 bg-white border border-slate-200 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-2">
              ...
              <div className="flex gap-2">
                ...
                />
                <button onClick={addNote} className="bg-[#102A2E] hover:bg-[#1D5146] text-white p-2.5 rounded-xl shrink-0">
                  <FiPlus />
                </button>
              </div>
            </div>
            ...
            {(plan || notes.length > 0) && (
              <div className="flex justify-between items-center mt-4 pt-3 border-t border-slate-200">
                ...
                <span className="text-xl font-black text-[#102A2E]">{formatCurrency(grandTotal)}</span>
              </div>
            )}
          </div>
        </div>
